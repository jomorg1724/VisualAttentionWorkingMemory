...
CONFIG="${1:-/workspace/spatial_priority_cloud.json}"
value() {
...
cd "$ROOT"
nohup "$VENV/bin/python" -B WorkingMemory/SpatialPriorityReadout/sweep.py \
