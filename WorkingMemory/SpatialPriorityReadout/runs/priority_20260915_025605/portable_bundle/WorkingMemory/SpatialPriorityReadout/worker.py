...
def run(job):
    ...
    model, optimizer, lineage = migrate(
        parent, ARM, cfg, job["parent_sha256"]
    )
    ...
    if checkpoint_path:
        ...
        if (
            ...
            or saved["lineage"]["parent_sha256"] != job["parent_sha256"]
        ):
    ...
    write(
        ...
        dict(
            ...
            inherited_adam_states=len(lineage["retained_adam_names"]),
            fresh_optimizer_states=len(
                [
                    name
