"""Cloud supervisor for one fixed-exposure spatial-priority-readout arm."""
import json
import platform
import re
import subprocess
...
from WorkingMemory.SpatialPriorityReadout.model import ARM, PARENT_SHA256
...
def run(manifest_path):
    ...
    if manifest["parent_sha256"] != PARENT_SHA256 or sha(parent) != PARENT_SHA256:
        raise RuntimeError("Not the exact intact attention8400 parent")
    ...
    if budget_path.exists():
        ...
        if (
            ...
            or aggregate["parent_sha256"] != PARENT_SHA256
        ...
        construction = subprocess.run(
            ...
            env={
                **__import__("os").environ,
                "SPATIAL_PRIORITY_PARENT": str(parent),
            },
        )
